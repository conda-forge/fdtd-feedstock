...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fdtd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14181&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fdtd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fdtd` can be installed with:

```
conda install fdtd
```

It is possible to list all of the versions of `fdtd` available on your platform with:
